  ...
  createInfoWindow : (marker_container) ->
    if typeof(@jsTemplate) == "function" or marker_container.description?
      ...
      if @markers_conf.custom_infowindow_class != null
        ...
        currentMap = this
        @openInfoWindow(currentMap, marker_container.infowindow, marker_container.serviceObject)
        google.maps.event.addListener(currentMap.serviceObject, 'mouseover', @openInfoWindow(currentMap, marker_container.infowindow, marker_container.serviceObject))
